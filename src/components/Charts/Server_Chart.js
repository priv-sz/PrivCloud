...
class Server_Chart extends React.Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        ...
        return (
            <div >
                <Chart height={400}  data={dv} scale={this.state.cols} forceFit onGetG2Instance={getG2Instance}>
                    <Legend
                        custom={true}
